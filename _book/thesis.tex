...
Second paragraph of abstract starts here.'}
  ...
  \prefacesection{Acknowledgements}{Thank your pals. Thank your profs. Thank your mom.
...
\CommentTok{\# Load packages (gaelsdown will load all of the packages as well)}
...
Many of the symbols you will need can be found at \url{http://web.reed.edu/cis/help/latex/math.html} and the Comprehensive LaTeX Symbol Guide (\url{http://mirror.utexas.edu/ctan/info/symbols/comprehensive/symbols-letter.pdf}).
...
In the \textbf{R} chunk below, we will load in a picture stored as \texttt{queens.png} in our main directory. We then give it the caption of ``Queen's logo,'' the label of ``queenslogo,'' and specify that this is a figure. Make note of the different \textbf{R} chunk options that are given in the R Markdown file (not shown in the knitted document).
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{include\_graphics}\NormalTok{(}\AttributeTok{path =} \StringTok{"figure/queens.png"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
\begin{figure}

{\centering \includegraphics[width=2.78in]{figure/queens} 

}

\caption{Queen's logo}\label{fig:queenslogo}
\end{figure}
Here is a reference to the Queen's logo: Figure \ref{fig:queenslogo}. Note the use of the \texttt{fig:} code here. By naming the \textbf{R} chunk that contains the figure, we can then reference that figure later as done in the first sentence here. We can also specify the caption for the figure via the R chunk option \texttt{fig.cap}.
...
If you'd like to see examples of other things in this template, please \href{https://github.com/eugenesit/gaelsdown/issues/new}{contact us} (email \href{mailto:eugene.sit@queensu.ca}{\nolinkurl{eugene.sit@queensu.ca}}). We love to see people using \emph{R Markdown} for their theses, and are happy to help.
